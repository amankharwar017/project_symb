...
export default function AssignmentUI() {
  ...
  async function addSlot(e) {
    ...
    try {
      ...
      const data = await res.json(); // saved slot
  ...
  async function parkVehicle() {
    ...
    try {
      ...
      const data = await res.json(); // parked slot
  ...
  async function removeVehicle() {
    ...
    try {
      ...
      const data = await res.json(); // updated slot
  ...
  return (
    <div className="container">
      ...
      <div className="box">
        ...
        <button className="btn" onClick={loadSlots}>
          Refresh List
        </button>
      ...
      <div className="box">
        ...
        <div className="row" style={{ marginBottom: 10 }}>
          ...
          <button className="btn" onClick={parkVehicle}>
            Park Vehicle
          </button>
        </div>
        ...
        <div className="row">
          ...
          />
          <button className="btn" onClick={removeVehicle}>
            Remove Vehicle
          </button>
        </div>
      </div>
